...
from lib.Util import from_jsonld, to_jsonld, encode_path, decode_path
...
jsonld = {
    ...
    "https://www.research-data-services.org/jsonld/irodscategory": "publication/thesis",
...
class TestJsonLd(unittest.TestCase):
    ...
    def test_encode_path(self):
        ...
        # assert
        self.assertEqual(path_new, 'L3lvZGEvcmVzZWFyY2gvdW50aXRsZWQtMTIzNA==')

    def test_decode_path(self):
        # arrange
        path = "L3lvZGEvcmVzZWFyY2gvdW50aXRsZWQtMTIzNA=="
        
        # act
        path_new = decode_path(path)
        
        # assert
        self.assertEqual(path_new, '/irods/research/untitled-1234')
