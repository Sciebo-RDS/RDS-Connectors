...
def bootstrap(name="MicroService", *args, **kwargs):
    ...
    dataverse_address = None
    if "address" in kwargs:
        dataverse_address = kwargs["address"]
        del kwargs["address"]

    dataverse_api_address = None
    if "api_address" in kwargs:
        dataverse_api_address = kwargs["api_address"]
        del kwargs["api_address"]


    app = App(name, *args, **kwargs)

    app.app.dataverse_address = dataverse_address
    app.app.dataverse_api_address = dataverse_api_address
...
app = bootstrap("PortDataverse", all=True)
