...
public class ScieboRdsService(HttpClient httpClient, IOptions<ScieboRdsConfiguration> configuration) : IScieboRdsService
{
    private readonly HttpClient httpClient = httpClient;
    private readonly ScieboRdsConfiguration configuration = configuration.Value;
    ...
    private static readonly string[] implements = [ "metadata" ];
